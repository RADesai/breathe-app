const Info = () => {
  return (
    <div className='p-4 bg-white'>
      <div className='max-w-(--breakpoint-md) flex justify-self-center'>
        ...
        diaphragm. The process is as follows : The intercostals contract; the
        rib cage elevates; the diaphragm contracts downward, the elevation of
        rib cage combined with the downward movement of the diaphragm creates
        negative density in the thoracic cavity,allowing air to be sucked into
        the lungs and the result is an expansion of the thoracic cavity. Other
        muscles involved in the process include the erector spinae, the
        semispinalis, the multifidus, the serratus posterior group and the inter
        spinalis-all of which contribute to the elevation of rib cage ,
        expansion of the chest, flattening of the thoracic curve, and vertical
        ...
        the back, moving into backbends, extension postures and straightening of
        ...
        pubic bone to navel. This contraction is initiated at the rectus
        abdominis, and then engages both the obliques and transverse
        abdominals.In certain circumstances we may also intentionally contract
        the superficial and deep musculature of the perineal floor, including
        the anal sphincter, the urethral sphincter, the levator ani muscles and
